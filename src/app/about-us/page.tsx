...
const About = () => {
  return (
      ...
      <div className='w-full h-[290px] bg-no-repeat bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(https://travelvaidya.com/wp-content/uploads/2025/02/Untitled-design-2025-02-12T183029.253.webp)] bg-cover bg-center'>
        <p className='pl-4 md:pl-8 text-3xl md:text-5xl font-extrabold text-white pt-20'>About Travel Vaidya</p>
        <p className='pl-4 md:pl-8 text-lg md:text-xl pt-4 text-white'>Trusted Travel Partner for Char Dham & Uttarakhand Tours</p>
      </div>
